...
# CMD ["bash"]
# But to get things running in this env a shell script is provided to setup a
# virtual python environment and start jupyter lab
ENTRYPOINT ["bash", "/root/gbr_model_map/entrypoint.sh"]
